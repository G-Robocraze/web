        ...
        $ = e => {
            ...
            if (e.params.rewind)
                for (let a = i - t; a <= r + t; a += 1) {
                    ...
                    for (let a = Math.max(r - t, 0); a <= Math.min(r + t, s - 1); a += 1) a !== i && a > r && k(e, a)
        };
    var I = {
        updateSize: function() {
            const e = this;
    ...
    const Z = {
            ...
            events: {
                attachEvents: function() {
                    ...
                    e.onTouchStart = H.bind(e), e.onTouchMove = X.bind(e), e.onTouchEnd = Y.bind(e), s.cssMode && (e.onScroll = q.bind(e)), e.onClick = R.bind(e), e.onLoad = _.bind(e), V || (t.addEventListener("touchstart", F), V = !0), j(e, "on")
                },
