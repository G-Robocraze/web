! function() {
    ...
    if (e) {
        ...
        if (r || (r = e.offsetHeight, s.style.paddingTop = r + "px", s.style.scrollPaddingTop = r + "px"), window.matchMedia("(max-width: 991px)").matches) {
            const l = e.querySelector(".navbar-collapse"),
                d = e.querySelector(".navbar-toggler");
            window.addEventListener("scroll", () => {
                var e = window.scrollY;
                "true" === d.getAttribute("aria-expanded") && 0 < e && (l.classList.remove("show"), d.setAttribute("aria-expanded", "false"))
            })
        }
    }
}();